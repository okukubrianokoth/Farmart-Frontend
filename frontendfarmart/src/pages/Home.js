      ...
      <div className="hero-section">
        <div className="container">
          <div className="hero-content">
            <h1>Welcome to Farmart</h1>
            <p>
              Buy farm animals directly from farmers. No middlemen. Better
              prices.
            </p>
            <div className="hero-buttons">
              {/* ✅ Fixed: navigate to /animals (matches Navbar route) */}
              <button
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              <h3>🚜 Direct from Farmers</h3>
              <p>
                Buy directly from trusted farmers without any middlemen taking
                commissions.
              </p>
            </div>
            <div className="feature-card">
              <h3>💰 Better Prices</h3>
              <p>
                Get competitive prices by eliminating unnecessary intermediaries.
              </p>
            </div>
            <div className="feature-card">
              <h3>🐄 Quality Animals</h3>
              <p>
                Access healthy, well-cared-for animals from reputable farms.
              </p>
            </div>
            <div className="feature-card">
              <h3>📱 Easy Platform</h3>
